export const reports = [
  { id: '1', title: '夏季交流戦 vs 唐桑ジュニアーズ', date: '2025-07-15', category: '試合', body: '本日の交流戦は6対4で勝利！3回裏の逆転打が試合を決めました。選手たちの成長を感じる一戦でした。全員が声を出し、最後まで諦めない姿勢が印象的でした。' },
  ...
  { id: '5', title: '練習試合 vs 本吉ファイターズ', date: '2025-06-15', category: '試合', body: '8対5で勝利！新しく練習したダブルプレーが実戦で決まりました。投手陣も安定した投球を見せてくれました。' },
...
export const reportDetail = {
  ...
  category: '試合',
  body: [
    { type: 'text', content: '6月30日、気仙沼市少年野球夏季大会の決勝戦が行われました。対戦相手は昨年の優勝チーム・大谷海岸イーグルス。選手たちは朝から気合十分で試合に臨みました。' },
    ...
    { type: 'score', home: '気仙沼シーホークス', away: '大谷海岸イーグルス', homeScore: 2, awayScore: 3, innings: ['0','1','0','1','0','0','—','2', '0','0','1','0','0','2','—','3'] },
